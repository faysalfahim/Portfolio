      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          ...
          <motion.div variants={item} className="mt-10 flex flex-wrap gap-3">
            <a
              href="#research"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-md bg-primary text-primary-foreground font-medium text-sm hover:opacity-90 transition-opacity focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
            >
              <BookOpen size={16} />
              View Research
            </a>
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-md border border-border text-foreground font-medium text-sm hover:bg-accent transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
            >
              <Mail size={16} />
              Email Me
            </a>
          ...
          <motion.div variants={item} className="mt-8 flex items-center gap-4">
            ...
            <a
              ...
              className="text-muted-foreground hover:text-foreground transition-colors text-xs font-bold border border-current rounded px-1.5 py-0.5 leading-none"
            >
              RG
            </a>
          </motion.div>
